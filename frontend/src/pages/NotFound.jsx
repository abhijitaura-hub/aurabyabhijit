  ...
  return (
    <>
      ...
      <section className="mx-auto flex min-h-[70vh] max-w-3xl flex-col items-center justify-center px-5 py-32 text-center" data-testid="not-found-page">
        <p className="font-mono-tech text-xs uppercase tracking-[0.32em] text-cyan-electric">404</p>
        ...
        <Link
          ...
          className="mt-10 inline-flex items-center gap-2 bg-white px-6 py-3.5 text-sm font-semibold text-black transition-colors duration-300 hover:bg-cyan-electric"
        >
          Back to AURA
        </Link>
      </section>
